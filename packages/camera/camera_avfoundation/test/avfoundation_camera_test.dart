  ...
  group('Function Tests', () {
    ...
    test('Should fetch CameraDescription instances for available cameras',
      ...
      final List<PlatformCameraDescription> returnData =
        ...
        PlatformCameraDescription(
            name: 'Test 1', zoomType: PlatformCameraZoomType.wide, lensDirection: PlatformCameraLensDirection.front),
        PlatformCameraDescription(
            name: 'Test 2', zoomType: PlatformCameraZoomType.wide, lensDirection: PlatformCameraLensDirection.back),
      ];
