...
- (void)availableCamerasWithCompletion:
        (nonnull void (^)(NSArray

<FCPPlatformCameraDescription *> *_Nullable,
FlutterError *_Nullable
))completion {
    dispatch_async(self.captureSessionQueue, ^{
        NSMutableArray *discoveryDevices =
                [@[ AVCaptureDeviceTypeBuiltInWideAngleCamera, AVCaptureDeviceTypeBuiltInTelephotoCamera, AVCaptureDeviceTypeBuiltInDualCamera ]
                        mutableCopy];
        ...
        for (AVCaptureDevice *device in devices) {
            ...
            if (device.deviceType == AVCaptureDeviceTypeBuiltInUltraWideCamera) {
              ...
              NSArray<AVCaptureDevice *> *dualCameraDevices = [devices filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(AVCaptureDevice *object, NSDictionary *bindings) {
                                                                        return object.deviceType == AVCaptureDeviceTypeBuiltInDualCamera;
                                                                      }]];
              if ([dualCameraDevices count] > 0) {
                zoomValue = [[dualCameraDevices firstObject].virtualDeviceSwitchOverVideoZoomFactors.lastObject doubleValue];
              } else {
                zoomValue = 2.0;
              }
        ...
        [reply sortUsingComparator: ^NSComparisonResult(FCPPlatformCameraDescription* obj1, FCPPlatformCameraDescription* obj2) {
            if(obj1.zoomValue < obj2.zoomValue) {
                return NSOrderedAscending;
            } else if (obj1.zoomValue > obj2.zoomValue) {
...
- (void)takePictureWithCompletion:(nonnull void (^)(NSString
...
- (void)stopVideoRecordingWithCompletion:(nonnull void (^)(NSString
...
- (void)getMinimumZoomLevel:(nonnull void (^)(NSNumber
...
- (void)getMaximumZoomLevel:(nonnull void (^)(NSNumber
...
- (void)setExposurePoint:(nullable FCPPlatformPoint
...
- (void)getMinimumExposureOffset:(nonnull void (^)(NSNumber
...
- (void)getMaximumExposureOffset:(nonnull void (^)(NSNumber
...
- (void)setFocusPoint:(nullable FCPPlatformPoint
...
- (void)updateDescriptionWhileRecordingCameraName:(nonnull NSString
...
- (void)createCameraOnSessionQueueWithName:(NSString *)name
                                ...
                                completion:(nonnull void (^)(NSNumber
